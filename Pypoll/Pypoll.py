...
csv_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'election_data.csv')
...
print(dict_candidates_and_votes)
...
output_file = Path("//Users//SRI//MonashBootcamp//Week//Python//Pypolloutput.txt")
